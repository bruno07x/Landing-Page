...
<body>
    <section>
        <div class="grid-full aguardando">
            <div class="">
                <img class="logo" src="IMG/nike_icon.png" alt="[ICONE NIKE]" title="Nike Icon">
                <h1 class="laranja slogan text-center">Parabéns!<br> Seu cadastro já está quase pronto ;)</h1>
            </div>
            <div class="">
                <p class="white bhead text-center">
                    Enviamos um link para seu e-mail para ativar sua reserva, após validar iremos te alertar quando o produto estiver disponível
                    para compra!
                </p>
            </div>
